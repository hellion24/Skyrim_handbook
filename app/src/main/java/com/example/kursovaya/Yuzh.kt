...
public class Yuzh extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
            ...
            public void onClick(View v) {
                ...
                new CountDownTimer(300, 1000) {
                    ...
                    public void onFinish() {
                        ...
                        Intent i = new Intent(Yuzh.this, Menu.class);
                        startActivity(i);
                    }
                }.start();
            }
        ...
        vozd.setText(Sost.get(2,0));
        voda.setText(Sost.get(2,1));
        poch.setText(Sost.get(2,2));
    }
}