...
public class Sibir extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
            ...
            public void onClick(View v) {
                ...
                new CountDownTimer(300, 1000) {
                    ...
                    public void onFinish() {
                        ...
                        Intent i = new Intent(Sibir.this, Menu.class);
                        startActivity(i);
                    }
                }.start();
            }
        ...
        vozd.setText(Sost.get(6,0));
        voda.setText(Sost.get(6,1));
        poch.setText(Sost.get(6,2));
    }
}